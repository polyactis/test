...
print "log likelihood of the sequence:", logp

# cacluate viterbi path 
path = model.viterbi(seq)

# train model parameters
baumWelch_logp = model.baumWelch(seq_set,5,0.01)
print "baumWelch log likelihood:", baumWelch_logp
print "After training on the data sampled from the model:"
print model

logp = model.loglikelihood(seq)
print "After-training log likelihood of the sequence:", logp