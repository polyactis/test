...
CC     COMPUTE D(K,J)
	CALL FILLD(NX, NY, U, V, D, DX, DY, DTIM)
...
C	WRITE(6,67)	(P(K,1),K=1,21)
C   67	FORMAT('P(K,1)=',21E11.4)

C	WRITE(6,59)(P(K,2),K=1,NY)
C   59	FORMAT('PRESSURE AT J=2',21E11.4)
C
C	WRITE(6,74)(P(K,3),K=1,NY)
C   74	FORMAT('PRESSURE AT J=3',21E11.4)
...
C	CALL VISC(DTIM,ALF,NX,NY,U,V,CCXA,CCYA, DX, DY)
...
CC	WRITE(6,73)	(DU((NY+1)/2,J),J=1,NX)
CC   73	FORMAT('DU AT CENTERLINE AFTER VISC STEP', 31E11.4)
C
CC
CC     INCREMENT T
C
...
C	PRINT RMS ERROR FOR THE U VELOCITY AT OUTFLOW
   ...
   47	FORMAT('FLOW RATE=',E11.4,' TIME=',E11.4,' RMSU=',D11.4,
     1' RMSQ=',D11.4)
	WRITE(6,48)(Q(J),J=1,NX)
   48	FORMAT('FLOW RATE='31E11.4)
